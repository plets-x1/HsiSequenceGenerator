...
using TestCase = Plets.Modeling.TestPlanStructure.TestCase;

namespace Plets.Modeling.FiniteStateMachine.Hsi {
    public class HsiMethod : SequenceGenerator {
        #region Attributes
        private Plets.Modeling.FiniteStateMachine.FiniteStateMachine fsm;
        ...
        public class FailnessRecord {
            ...
            public String Input = Plets.Modeling.FiniteStateMachine.FiniteStateMachine.EPSILON;
